//! Live login through a typed second-factor code rather than
...
//!
//! Run:
//!   $env:RUST_LOG="info"; cargo run --release --example live_2fa_code_provider
//!
...
//! The socket down. There is no retry loop.
