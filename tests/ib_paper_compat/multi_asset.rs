...
pub(super) fn phase_concurrent_orders(conns: Conns) -> Conns {
    ...
    control_tx.send(ControlCommand::Subscribe { req_id: 90032, contract: ibkr_dx::types::ContractRef { con_id: 756733, symbol: "SPY".into(), exchange: String::new(), sec_type: "STK".into(), currency: String::new(), last_trade_date: String::new(), strike: 0.0, right: String::new(), multiplier: String::new() }, filters: Default::default(), mode_9887: 0, delayed_mode: None, regulatory_snapshot: false, snapshot: false,
...
pub(super) fn phase_crypto_fill(conns: Conns) -> Conns {
    ...
    control_tx.send(ControlCommand::Subscribe { req_id: 90033, contract: ibkr_dx::types::ContractRef { con_id: 479624278, symbol: "BTC".into(), exchange: "PAXOS".into(), sec_type: "CRYPTO".into(), currency: "USD".into(), last_trade_date: String::new(), strike: 0.0, right: String::new(), multiplier: String::new() }, filters: Default::default(), mode_9887: 0, delayed_mode: None, regulatory_snapshot: false, snapshot: false,
        generic_ticks: Vec::new(), news: None, spread_scan: None, calculation: None,
    }).unwrap();
    let join = run_hot_loop(hot_loop);
