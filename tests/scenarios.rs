...
fn order_lifecycle_partial_then_full_fill() {
    ...
    shared.orders.push_order_update(OrderUpdate {
        ...
        filled_qty: 0.0, remaining_qty: 200.0, avg_price: 0, perm_id: 0, parent_id: 0, timestamp_ns: 1000,
    });
...
fn order_lifecycle_partial_fill_then_cancel() {
    ...
    shared.orders.push_order_update(OrderUpdate {
        ...
        filled_qty: 30.0, remaining_qty: 70.0, avg_price: 0, perm_id: 0, parent_id: 0, timestamp_ns: 2000,
    });
    w.events.clear();
    client.process_msgs(&mut w);
...
fn mixed_ticks_during_fills() {
    ...
    shared.orders.push_order_update(OrderUpdate {
        ...
        filled_qty: 0.0, remaining_qty: 200.0, avg_price: 0, perm_id: 0, parent_id: 0, timestamp_ns: 0,
    });
...
fn mixed_news_between_orders() {
    ...
    shared.orders.push_order_update(OrderUpdate {
        ...
        filled_qty: 0.0, remaining_qty: 100.0, avg_price: 0, perm_id: 0, parent_id: 0, timestamp_ns: 1000,
    });
